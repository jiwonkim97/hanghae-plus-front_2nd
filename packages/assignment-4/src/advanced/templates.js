...
export const CartItem = (item) => `<div class="flex justify-between items-center mb-2">
...
export const CartTotal = ({total, discountRate}) => `총액: ${total}원${discountRate !== 0 && `(${(discountRate * 100).toFixed(1)}% 할인 적용)`}`;
